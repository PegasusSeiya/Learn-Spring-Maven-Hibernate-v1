...
public class IndexController {
	 ...
	 * Version 1
	 * 
	 * @EJB(mappedName = "java:module/WelcomeEJB") private WelcomeEJB
	 * welcomeEJB;
	 */

	/*
	 * Version 2: Récupérer une référence vers l'ejb comme si c'était un
	 * composant Spring.
	 */
	/*
	 * @Inject private WelcomeEJB welcomeEJB;
	 */
	...
	public String backlog(HttpServletRequest request, HttpServletResponse response) {
		return "backlog";
	}

	private void saveSomeTasks() {

		taskService.save(buildTask("Write Changelog", "Write Changelog since begining and indicate projet's guidelines",
				"changelog,update,software building"));
		taskService.save(buildTask("Read Effective Java, Play with Cobol", "Read Effective Java before it's too late",
				"java,cobol,effective"));
