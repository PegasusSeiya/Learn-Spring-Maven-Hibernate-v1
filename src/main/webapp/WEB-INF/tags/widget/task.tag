...
<div>
	...
	<span class="lead"><a href="${contextPath}/edit/${task.id}">${fn:escapeXml(task.title)}</a></span>
	...
	<a href="${contextPath}/edit/${task.id}/delete"><button class="btn btn-danger"></button></a>
</div>